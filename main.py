...
REAL_APIS = {
    "mobile": [
        {"name": "MobileAPI1", "url": "https://ayaanmods.site/mobile.php?key=annonymousmobile&term={number}", "working": True},
        {"name": "MobileAPI2", "url": "https://devil.elementfx.com/api.php?key=DANGER&type=number_v1&term={number}", "working": True},
    ],
    "aadhaar": [
