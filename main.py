    ...
    for api in REAL_APIS[api_type]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # 🔁 REPLACE DEVELOPER NAME (sirf ye 2 lines add karo)
                if isinstance(data, dict) and 'API_Developer' in data:
                    data['API_Developer'] = '@Danger_devil1917'
                if isinstance(data.get('result'), dict) and 'API_Developer' in data['result']:
                    data['result']['API_Developer'] = '@Danger_devil1917'
